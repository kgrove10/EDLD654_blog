...
Finally, we're ready to create a model! This is discussed with more specifics to each model on their respective blog posts, but there are a few elements we will need to specify for each model.
