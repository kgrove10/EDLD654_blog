...
![RMSE plot](https://www.dropbox.com/s/snu676nlu1014yi/rmse_auc.png?dl=0)
...
The plot below shows the root nodes from a bagged tree made of 60 trees (6 folds x 10 resamples). As notes based on our RMSE, the optimal number of resamples (trees) is 175 but for time and computional eficiency purposes we only set it to 10 in this visualization.

Root nodes are the 1st node in a decision tree, and they are determined by which variable best optimizes a loss function (e.g., minimizes RMSE for continuous outcomes or Gini Index for categorical outcomes).  
...
![Root nodes visualisation](https://www.dropbox.com/s/azkgm00earj5nvr/bagtree_root.png?dl=0)
...
![Metrics Table](https://www.dropbox.com/s/m8hbr7mvqkjcq1z/bag_trees%20metrics%20table.png?dl=0)
